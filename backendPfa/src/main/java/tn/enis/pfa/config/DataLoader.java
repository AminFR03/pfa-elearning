...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        var m1 = CourseModule.builder().title("Les bases").orderIndex(0).course(c1).build();
        ...
        var m2 = CourseModule.builder().title("API REST").orderIndex(1).course(c1).build();
        ...
        var m3 = CourseModule.builder().title("Composants").orderIndex(0).course(c2).build();
